	...
	<section class="ftco-section ftco-no-pt ftco-no-pb">
		<div class="container-fluid px-0">
			<div class="row d-flex no-gutters">
				<div
					class="col-md-6 order-md-last ftco-animate makereservation p-4 p-md-5 pt-5">
					<div class="py-md-5">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:input path="phone" type="text" class="form-control"
											placeholder="Phone" />
										<form:errors path="phone" class="ui error message" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:input path="time" type="text" class="form-control"
											id="book_time" placeholder="Time" />
										<form:errors path="time" class="ui error message" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="select-wrap one-third">
											...
											<form:select path="person" name="" id="" class="form-control">
												<option value="1">1</option>
												<option value="2">2</option>
												<option value="3">3</option>
												<option value="4+">4+</option>
											</form:select>
											<form:errors path="person" class="ui error message" />
										</div>
									</div>
								</div>
